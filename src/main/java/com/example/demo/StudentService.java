...
//        }
    ...
    public Student deleteStudent(@PathVariable long id) throws Exception {
        ...
        if (DemoApplication.studentRepository.exists(String.valueOf(id))) {
            student = DemoApplication.studentRepository.findById(id);
            DemoApplication.studentRepository.delete(student);
...
//            DemoApplication.hmStudent.remove(new Long(id));
    ...
    public Student getStudent(@PathVariable long id){
        return DemoApplication.studentRepository.findById(id);
    }
}
